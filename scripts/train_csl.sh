...
OUTPUT_DIR="result_train/csl_bs${BATCH_SIZE}_${RUN_TAG}_${TIME_NOW}"
...
--data_path data_csl \
--features_path "/sda/home/shihaoyu/Projects/SEDS-master/Datasets/CSL/RTM_Keypoints/" \
--features_RGB_path "/sda/home/shihaoyu/Projects/SEDS-master/Datasets/CSL/I3D_features/" \
